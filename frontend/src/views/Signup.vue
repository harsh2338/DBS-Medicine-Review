<template>
  <div class="form">
        ...
        <h3> Already have an account? <router-link class="link" :to="{ name: 'login' }">Sign in...</router-link></h3>
        ...
        <BaseInput placeholder="Mobile Number" type="text"     v-model.number="user.mobnum"/>
